...
) ENGINE=InnoDB AUTO_INCREMENT=34915 DEFAULT CHARSET=utf8;
...
CREATE TABLE `audit_entry` (
  ...
  KEY `idx_route` (`route`)
) ENGINE=InnoDB AUTO_INCREMENT=12740 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `aula` VALUES (5,2,0,NULL),(5,3,0,''),(5,7,1,'esto es un motivo laaaaaaaaaaaaaaaaaaaaaaaaaaaargo'),(6,5,0,NULL),(6,6,0,NULL),(6,7,0,NULL),(6,8,0,NULL);
...
INSERT INTO `auth_assignment` VALUES ('admin','2',NULL),('persona_crear','19',1647875990),('prestacion_acreditar','19',1647878582),('prestacion_acreditar','2',1611922871),('prestacion_baja','19',1647875990),('prestacion_baja','2',1611922871),('prestacion_crear','19',1647875990),('prestacion_crear','2',1611922871),('prestacion_ver','19',1647875989),('prestacion_ver','2',1611922871),('usuario','19',1647875881);
...
INSERT INTO `recurso` VALUES (5,'2022-03-22','2022-04-01',150000,'','Taller de Yoga',3,2,1,NULL,NULL,NULL,2640,NULL,NULL,NULL,1,50000,'2022-06-01','Fioravanti'),(6,'2022-03-22','2021-07-28',150000,'','Taller de Yoga',3,2,1,NULL,NULL,NULL,2640,NULL,NULL,NULL,1,50000,'2021-09-07','Fioravanti');
...
INSERT INTO `user` VALUES (2,'admin','admin@correo.com','$2y$10$MnF9LJCnya.NrXIQBN4YGuRIdIuGtOSsGqqZTpby9RnFp7Chb4qEm','maXx0ibz2Br9UEfP06TVcltr0uOiWl4B',1556894840,NULL,NULL,'172.18.0.2',1556894840,1648214077,0,1648214077);
...
INSERT INTO `user_persona` VALUES (2,0,2626,NULL,NULL,'172.22.0.8');
...
-- Dump completed on 2022-04-08 13:44:19
